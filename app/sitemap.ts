...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: 'https://norinly.live/compare/tandem-alternative', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://norinly.live/compare/speaky-alternative', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://norinly.live/compare/preply-alternative', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://norinly.live/compare/busuu-alternative', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
